  ...
  return (
    <div className="max-w-5xl mx-auto space-y-10 animate-in fade-in duration-700 pb-20">
      ...
      <section className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        ...
        <button className="px-6 py-3 bg-white/5 border border-card-border text-white rounded-2xl font-black text-[10px] uppercase tracking-wider shadow-xl hover:bg-white/10 transition-all flex items-center gap-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
         <div className="bg-card border border-card-border p-8 rounded-[2.5rem] relative overflow-hidden group">
            ...
            <div className="space-y-4 relative z-10">
               ...
               <div>
                  <p className="text-[10px] font-black uppercase tracking-wider text-muted-text">Total Emprunté</p>
         ...
         <div className="bg-card border border-card-border p-8 rounded-[2.5rem] relative overflow-hidden group">
            ...
            <div className="space-y-4 relative z-10">
               ...
               <div>
                  <p className="text-[10px] font-black uppercase tracking-wider text-muted-text">Taux de Remboursement</p>
               ...
               <p className="text-[9px] font-bold text-green-500 uppercase tracking-wider">+ {repaymentRate === 100 ? 'Excellent' : 'Bon'} Profil</p>
            </div>
         </div>
         ...
         <div className="bg-primary p-8 rounded-[2.5rem] relative overflow-hidden group shadow-lg shadow-primary/20 flex flex-col justify-between">
            ...
            <div className="space-y-4 relative z-10">
               ...
               <div>
                  <p className="text-[10px] font-black uppercase tracking-wider text-foreground/70">Total Remboursé</p>
            ...
            <Link 
               ...
               className="mt-6 w-full py-4 bg-white text-primary text-center font-black rounded-2xl hover:bg-gray-200 transition-all uppercase text-[10px] tracking-wider shadow-xl active:scale-95 block relative z-10"
            >
      ...
      <div className="bg-card border border-card-border rounded-[3rem] p-8 md:p-12 relative overflow-hidden">
         ...
         <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-6">
            <div className="space-y-1">
               ...
               <p className="text-[10px] font-bold uppercase tracking-wider text-muted-text">Dépenses vs Remboursements (6 derniers mois)</p>
            </div>
            <div className="flex gap-2 p-1 bg-white/5 rounded-2xl border border-card-border">
               <button className="px-4 py-2 bg-background text-white rounded-xl text-[9px] font-black uppercase tracking-wider shadow-sm">6 Mois</button>
               <button className="px-4 py-2 text-muted-text hover:text-white rounded-xl text-[9px] font-black uppercase tracking-wider transition-colors">1 An</button>
               <button className="px-4 py-2 text-muted-text hover:text-white rounded-xl text-[9px] font-black uppercase tracking-wider transition-colors">Tout</button>
            </div>
         </div>
         ...
         <div className="flex items-center justify-center gap-8 mt-10">
            <div className="flex items-center gap-2">
               ...
               <span className="text-[9px] font-black uppercase tracking-wider text-muted-text">Emprunts</span>
            </div>
            <div className="flex items-center gap-2">
               <div className="w-3 h-3 rounded-sm bg-primary shadow-[0_0_10px_rgba(81,32,179,0.5)]"></div>
               <span className="text-[9px] font-black uppercase tracking-wider text-muted-text">Remboursements</span>
            </div>
         </div>
      </div>
    </div>
