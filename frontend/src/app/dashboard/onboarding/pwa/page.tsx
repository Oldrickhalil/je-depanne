    ...
    <div className="min-h-[80vh] flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-md bg-card border border-card-border rounded-3xl p-8 shadow-2xl space-y-8 relative overflow-hidden">
        ...
        <div className="text-center space-y-4">
          ...
          <h1 className="text-3xl font-bold text-foreground tracking-tight">Accès Rapide</h1>
          <p className="text-muted-text">Ajoutez Je Dépanne à votre écran d'accueil pour une expérience fluide et des notifications instantanées.</p>
        </div>

        {isIOS ? (
          <div className="space-y-6 animate-in fade-in duration-700">
            <div className="bg-white/5 border border-card-border rounded-2xl p-6 space-y-4">
              <p className="text-sm font-medium text-foreground flex items-center gap-2">
                Instructions pour iPhone/iPad :
              </p>
              <ol className="space-y-4">
                <li className="flex items-center gap-3 text-sm text-muted-text">
                  <span className="w-6 h-6 rounded-full bg-white/10 flex items-center justify-center text-xs font-bold text-foreground shrink-0">1</span>
                  <span>Appuyez sur le bouton <Share className="w-4 h-4 inline mx-1 text-blue-400" /> Partager en bas de l'écran.</span>
                </li>
                <li className="flex items-center gap-3 text-sm text-muted-text">
                  <span className="w-6 h-6 rounded-full bg-white/10 flex items-center justify-center text-xs font-bold text-foreground shrink-0">2</span>
                ...
                <li className="flex items-center gap-3 text-sm text-muted-text">
                  ...
                  <span className="text-foreground font-bold">Fermez Safari et ouvrez la nouvelle application depuis votre écran d'accueil pour valider automatiquement !</span>
                </li>
              </ol>
            </div>
          ...
          <div className="space-y-4">
            {deferredPrompt ? (
              ...
              <div className="text-center p-6 bg-white/5 border border-card-border rounded-2xl space-y-3">
                 <p className="text-sm text-muted-text">L'application est déjà installée ou votre navigateur ne supporte pas l'installation automatique.</p>
                 <button
                  onClick={markAsInstalled}
