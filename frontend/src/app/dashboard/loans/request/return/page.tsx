      ...
      {status === "loading" && (
        <>
          ...
          <div className="space-y-2">
             ...
             <p className="text-gray-500 text-[10px] font-bold uppercase tracking-[0.2em]">Veuillez patienter quelques instants...</p>
          </div>
        </>
      )}
        ...
        <>
          ...
          <div className="space-y-4">
             <div className="space-y-1">
                ...
                <p className="text-gray-400 text-[10px] font-bold uppercase tracking-[0.2em]">Votre compte personnel est maintenant configuré</p>
             </div>
             <button 
